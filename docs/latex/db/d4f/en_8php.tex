\section{Dokumentace souboru app/index/translate/en.php}
\label{db/d4f/en_8php}\index{app/index/translate/en.php@{app/index/translate/en.php}}
\subsection*{Proměnné}
...
\index{en.php@{en.php}!\$ttable@{\$ttable}}
\index{\$ttable@{\$ttable}!en.php@{en.php}}
