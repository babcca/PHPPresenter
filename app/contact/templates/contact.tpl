...
<table>
	<tr>
		...
		<form action="" method="post" enctype="multiple/form-data" id="ContactForm">
			...
			<label class="contact_label">Name:</label> <input type="text" name="name" id="Name" size="31" /><br />
			<label class="contact_label">Email:</label> <input type="text" name="email" id="Email" size="31" /><br />
			<label class="contact_label">Phone:</label> <input type="text" name="phone" id="Phone" size="31" /><br />
